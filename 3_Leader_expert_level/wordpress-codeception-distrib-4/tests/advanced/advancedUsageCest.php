...
php vendor/bin/codecept run --steps advanced advancedUsageCest
php vendor/bin/codecept run -vvv --steps advanced advancedUsageCest
php vendor/bin/codecept run --debug --steps advanced advancedUsageCest
php vendor/bin/codecept run --debug --steps advanced advancedUsageCest
