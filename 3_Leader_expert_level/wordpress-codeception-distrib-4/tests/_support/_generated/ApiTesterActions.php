<?php  //[STAMP] a8853bcb7801dc63e22638c604cc1e6c
...
trait ApiTesterActions
{
	 ...
	 * 
	 * @return string
     * @see \Helper\Api::getSchemaFile()
     */
    public function getSchemaFile($file) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getSchemaFile', func_get_args()));
    }
     ...
     * @see \Helper\Api::getUrlFromConfiguration()
     */
    public function getUrlFromConfiguration($apiKey) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getUrlFromConfiguration', func_get_args()));
    }
