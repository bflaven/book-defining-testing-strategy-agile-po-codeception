...
php vendor/bin/codecept run -vvv --steps acceptance CheckWpBackAddPostCategoryCest
php vendor/bin/codecept run --debug --steps acceptance CheckWpBackAddPostCategoryCest
...
class CheckWpBackAddPostCategoryCest
{
